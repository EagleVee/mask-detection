...
# get_ipython().system('git clone https://github.com/EagleVee/mask-detection')
...
# get_ipython().system('ls mask-detection/experiements/dest_folder/')
...
image_datasets = {x: datasets.ImageFolder(os.path.join(experiments_path, x), data_transforms[x]) for x in
                  ['train', 'test']}
...
#
#
# get_ipython().system('cd /content/gdrive/')
#
# # In[ ]:
#
#
...
torch.save(model_ft, '../model/mask1_model.pth')
